...
def create_evaluation(db: Session, llm_output_id: int, ground_truth: Optional[str] = None,
                      ...
                      llm_rag_wer: Optional[float] = None) -> Evaluation:
...
def update_evaluation_wer(db: Session, evaluation_id: int, whisper_wer: Optional[float] = None,
                          llm_wer: Optional[float] = None, llm_rag_wer: Optional[float] = None):
